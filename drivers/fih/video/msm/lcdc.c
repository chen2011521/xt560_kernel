...
static int lcdc_probe(struct platform_device *pdev)
{
    ...
    printk(KERN_ERR "xjj lcdc_probe: platform_device_add_data \n");
...
/*
  SD4_FIHNJ jenny
  mm-qcamera-test run well 
  depond on the fb_imgType as MDP_RGBA_8888
*/
    ...
    printk(KERN_ERR "xjj lcdc_probe mfd->fb_imgType%d: platform_device_add_data \n",mfd->fb_imgType);
	fbi = mfd->fbi;
