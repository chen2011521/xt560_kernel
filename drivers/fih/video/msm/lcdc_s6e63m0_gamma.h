...
/* gamma value: */
/*FIH-NJ-SW4 jenny modify the coordinate to (0.3000, 0.3100) provided by sumsung ++*/
static const unsigned int s6e63m0_all_300[] = {
	0x18, 0x08, 0x24, 0x42, 0x51, 0x25, 0xB0,
	0xBA, 0xA5, 0xAB, 0xB3, 0x9F, 0xBB, 0xC2,
	0xB3, 0x00, 0xB8, 0x00, 0xA9, 0x00, 0xF0
};

static const unsigned int s6e63m0_all_280[] = {
	0x18, 0x08, 0x24, 0x40, 0x4C, 0x25, 0xB2,
	0xBB, 0xA8, 0xAB, 0xB4, 0x9F, 0xBE, 0xC4,
	0xB5, 0x00, 0xB1, 0x00, 0xA3, 0x00, 0xE8
};

static const unsigned int s6e63m0_all_260[] = {
	0x18, 0x08, 0x24, 0xB4, 0xBD, 0xA9, 0xB3,
	0xBC, 0xA8, 0xAC, 0xB5, 0xA1, 0xBF, 0xC5,
	0xB6, 0x00, 0xAB, 0x00, 0x9E, 0x00, 0xE0
};

static const unsigned int s6e63m0_all_240[] = {
	0x18, 0x08, 0x24, 0x42, 0x4B, 0x28, 0xB3,
	0xBC, 0xA8, 0xAE, 0xB7, 0xA3, 0xC0, 0xC6,
	0xB7, 0x00, 0xA5, 0x00, 0x98, 0x00, 0xD8
};

static const unsigned int s6e63m0_all_220[] = {
	0x18, 0x08, 0x24, 0x43, 0x4B, 0x2A, 0xB3,
	0xBC, 0xA8, 0xAF, 0xB8, 0xA4, 0xC2, 0xC8,
	0xB9, 0x00, 0x9F, 0x00, 0x92, 0x00, 0xD0

};

static const unsigned int s6e63m0_all_200[] = {
	0x18, 0x08, 0x24, 0x44, 0x4D, 0x2A, 0xB4,
	0xBD, 0xA9, 0xAF, 0xB9, 0xA5, 0xC3, 0xC9,
	0xBA, 0x00, 0x99, 0x00, 0x8D, 0x00, 0xC8
};

static const unsigned int s6e63m0_all_180[] = {
	0x18, 0x08, 0x24, 0x44, 0x4A, 0x2A, 0xB5,
	0xBE, 0xAB, 0xB1, 0xBA, 0xA6, 0xC5, 0xCA,
	0xBC, 0x00, 0x91, 0x00, 0x86, 0x00, 0xBE
};

static const unsigned int s6e63m0_all_160[] = {
	0x18, 0x08, 0x24, 0x45, 0x49, 0x2A, 0xB5,
	0xBE, 0xAB, 0xB2, 0xBB, 0xA7, 0xC6, 0xCC,
	0xBD, 0x00, 0x8B, 0x00, 0x80, 0x00, 0xB6
};

static const unsigned int s6e63m0_all_140[] = {
	0x18, 0x08, 0x24, 0x47, 0x46, 0x2C, 0xB5,
	0xBE, 0xAB, 0xB4, 0xBD, 0xA9, 0xC8, 0xCE,
	0xBF, 0x00, 0x83, 0x00, 0x79, 0x00, 0xAC
};

static const unsigned int s6e63m0_all_120[] = {
	0x18, 0x08, 0x24, 0x49, 0x43, 0x2E, 0xB7,
	0xC0, 0xAD, 0xB5, 0xBE, 0xAA, 0xC9, 0xD0,
	0xC1, 0x00, 0x7B, 0x00, 0x71, 0x00, 0xA1
};

static const unsigned int s6e63m0_all_100[] = {
	0x18, 0x08, 0x24, 0x49, 0x3D, 0x2E, 0xB7,
	0xC0, 0xAD, 0xB7, 0xBF, 0xAC, 0xCC, 0xD2,
	0xC5, 0x00, 0x72, 0x00, 0x69, 0x00, 0x95
};

static const unsigned int s6e63m0_all_80[] = {
	0x18, 0x08, 0x24, 0x4B, 0x35, 0x2E, 0xB8,
	0xC0, 0xAE, 0xB8, 0xC1, 0xAD, 0xCC, 0xD3,
	0xC5, 0x00, 0x69, 0x00, 0x61, 0x00, 0x8A
};
/*FIH-NJ-SW4 jenny modify the coordinate to (0.3000, 0.3100) provided by sumsung--*/
...
struct s6e63m0_gamma {
    ...
    unsigned int *gamma_all_table[MAX_GAMMA_LEVEL];
};
...
static struct s6e63m0_gamma gamma_table = {
	...
	.gamma_all_table[0] = (unsigned int *)&s6e63m0_all_80,
	.gamma_all_table[1] = (unsigned int *)&s6e63m0_all_80,//s6e63m0_all_100,
	.gamma_all_table[2] = (unsigned int *)&s6e63m0_all_120,
	.gamma_all_table[3] = (unsigned int *)&s6e63m0_all_140,
	.gamma_all_table[4] = (unsigned int *)&s6e63m0_all_180,
	.gamma_all_table[5] = (unsigned int *)&s6e63m0_all_200,
	.gamma_all_table[6] = (unsigned int *)&s6e63m0_all_220,
	.gamma_all_table[7] = (unsigned int *)&s6e63m0_all_240,
	.gamma_all_table[8] = (unsigned int *)&s6e63m0_all_260,
	.gamma_all_table[9] = (unsigned int *)&s6e63m0_all_280,
	.gamma_all_table[10] = (unsigned int *)&s6e63m0_all_300,
};
