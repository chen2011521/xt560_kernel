...
/* FIHTDC, Div2-SW2-BSP PeterKCTseng, cts, 2011/10/18 { */
// [CTS] android.permission.cts.FileSystemPermissionTest#testAllFilesInSysAreNotWritable
	snprintf(name, sizeof name, "msm_snd_adie");
	dentry = debugfs_create_file(name, 0220, /* S_IFREG | S_IRUGO | S_IWUGO, */
