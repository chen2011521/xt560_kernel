...
// FIH,Tiger,add FIH projects definition +[
...
#if 0	// remove sx150x driver registry to avoid i2c fail when download reboot
	{
		I2C_BOARD_INFO("sx1508q", 0x22),
		.platform_data	= &sx150x_data[SX150X_CAM],
	},
#endif	// remove sx150x driver registry to avoid i2c fail when download reboot
};
#endif
#if defined(CONFIG_BT) && defined(CONFIG_MARIMBA_CORE)
...
#if defined(CONFIG_BT) && defined(CONFIG_MARIMBA_CORE)
// FIH,Tiger,remove Qualcomm default devices+[
#ifndef CONFIG_USE_QUALCOMM_DEFT_DEVICES
	(void)bt_power_init;
	(void)bahama_devices;
#else
	i2c_register_board_info(MSM_GSBI1_QUP_I2C_BUS_ID,
...
/* FIHTDC, Div2-SW2-BSP, Penho, IRM.B-2087 { */
...
/*
* If Qualcomm update the SDCC code, 
* please update "fih_sdcc.c" too.
*/
...
{
	int ret = -ENODEV;
#if defined(CONFIG_FB_MSM_LCDC_S6E63M0_WVGA_PT_PANEL) && defined(CONFIG_FIH_7X27A_PROJS)
   if (!strncmp(name, "lcdc_s6e63m0_wvga_pt", 21)){
                ret = 0;
   }else {
		ret = -ENODEV;
	}
...
/* Porting 1090 */
// Div2-SW5-BSP-Audio-FMRadio-00+[
	SND(FM_HEADSET, 29),
	SND(FM_SPEAKER, 30),
// Div2-SW5-BSP-Audio-FMRadio-00+]	
// Div2-SW5-BSP-Audio-IRM.B-1338-01+[
	SND(HEADSET_AND_SPEAKER, 31),
// Div2-SW5-BSP-Audio-IRM.B-1338-01+]	
	SND(CURRENT, 0x7FFFFFFE),
	SND(FM_ANALOG_STEREO_HEADSET, 35),
	SND(FM_ANALOG_STEREO_HEADSET_CODEC, 36),
// Div2-SW5-BSP-Audio-HAC-00+{
	SND(HAC_HANDSET, 37),
// Div2-SW5-BSP-Audio-HAC-00+}
// Div2-SW5-BSP-Audio-CTS-00+{
	SND(STEREO_HEADSET_WITH_INNER_MIC, 38),
// Div2-SW5-BSP-Audio-CTS-00+}
};
#undef SND
...
#else	/* !CONFIG_USE_QUALCOMM_DEFT_DEVICES */
static struct platform_device *surf_ffa_devices[] __initdata = {
	&msm_device_dmov,
	&msm_device_smd,
	&msm_device_uart1,
...
#endif	/* !CONFIG_USE_QUALCOMM_DEFT_DEVICES */
// FIH,Tiger,remove Qualcomm default devices+]
...
static void __init msm_fb_add_devices(void)
{
	...
	fih_fb_device_init();
#else
	msm_fb_register_device("lcdc", &lcdc_pdata);//IRMPrime
...
static struct msm_handset_platform_data hs_platform_data = {
	.hs_name = "7k_handset",
	.pwr_key_delay_ms = 0, /* 0 will disable end key */ /*FIHTDC, Disable end key, MayLi, 2011.09.15*/
};
...
/* FIH, Ming, Remove smsc911x { */
#ifdef CONFIG_FIH_CONFIG_GROUP
		(void)smsc911x_device;
		(void)msm7x27a_cfg_smsc911x;
#else
...
/* } FIH, Ming, Remove smsc911x */
	...
	// FIH,Tiger,enable fih projects resources +[
	initialize_fih_projects();
	// FIH,Tiger,enable fih projects resources +]

	// FIH,Tiger,remove Qualcomm default devices+[
#ifndef CONFIG_USE_QUALCOMM_DEFT_DEVICES
	(void)android_usb_device;
	(void)usb_mass_storage_device;
	(void)atmel_ts_i2c_info;
	(void)kp_pdev;
	(void)led_pdev;
	(void)msm_flash_src;
	(void)msm_camera_sensor_mt9e013;
	(void)msm_camera_sensor_s5k4e1_data;
	(void)msm_camera_sensor_ov9726_data;
	(void)msm_batt_device;  //Debbie, 2011/09/15
