...
/* Debbie add, 2011/09/06 { */
/* 1090 porting */
extern void fih_hsusb_chg_vbus_draw(unsigned mA);
/* Debbie add, 2011/09/06 } */
...
void hsusb_chg_connected(enum chg_type chgtype)
{
	...
	/* 1070 porting*/
	msm_batt_update_charger_type(chgtype);	// Div2-SW2-BSP-IRM-CHG 
	/* FIH, Debbie, 2011/08/12 } */
