...
#define MSM_DEBUGMASK_BASE          IOMEM(0xFB400000)
#define MSM_DEBUGMASK_PHYS          0xFF000
#define MSM_DEBUGMASK_SIZE          SZ_4K
/*FIH, KanyYJLin, debugmask, 2011/09/22{*/

// FIHTDC, HenryMCWang, 2011.10.31, for new hardware table, +++
#define MSM_HW_TABLE_BASE         IOMEM(0xFB500000)
#define MSM_HW_TABLE_PHYS         0x2D300000
#define MSM_HW_TABLE_SIZE          SZ_1M
// FIHTDC, HenryMCWang, 2011.10.31, for new hardware table, ---

// improve memory fragmentation issue, chihchia +++
#define MSM_BCM4330_WIPHY_ADDR    IOMEM(0xFB580000)
// improve memory fragmentation issue, chihchia ---