...
enum
{
    ...
    DEBUG_POWER_ON_BATT_THRESHOLD = 67,
...
enum
{
    DEBUG_CHARGING_CERTIFICATION_TEST_ITEM_START = 4,
    DEBUG_CHARGING_HEAT_THREASHOLD = DEBUG_CHARGING_CERTIFICATION_TEST_ITEM_START,
    DEBUG_AC_CHARGING_CURRENT = 5,
    DEBUG_USB_CHARGING_CURRENT = 6,
    MAX_DEBUG_CHARGING_CERTIFICATION_TEST_ITEM_END = 8 //MAX < 8       
};
