...
*/
static long ftm_phone_dev_ioctl(struct file * file, unsigned int cmd, unsigned long arg)
{
    int rc = 0;
...
static struct file_operations ftm_phone_dev_fops = {
    ...
    .unlocked_ioctl  =  ftm_phone_dev_ioctl,  /* new linux kernel uses '.unlocked_ioctl' instead of '.ioctl' */
...
MODULE_AUTHOR("Henry Wang <HenryMCWang@fihtdc.com>");  /* 2011/05/12 NickyTseng revised */
